...
parser.add_argument('--job_folder', type=str, default='./simulator/spark_env/tpch/',
                    help='job folder path (default: ./simulator/spark_env/tpch/)')
parser.add_argument('--result_folder', type=str, default='./simulator/results/',
                    help='Result folder path (default: ./simulator/results)')
parser.add_argument('--model_folder', type=str, default='./simulator/models/',
...
parser.add_argument('--num_init_dags', type=int, default=1,
                    help='Number of initial DAGs in system (default: 1)')
parser.add_argument('--num_stream_dags', type=int, default=50,
                    help='number of streaming DAGs (default: 50)')
...
parser.add_argument('--stream_interval', type=int, default=30000,
                    help='average inter job arrival time in milliseconds (default: 30000)')
...
parser.add_argument('--tpch_size', type=str,
                    default=['2g','10g','50g'], nargs='+',
                    help='Numer of TPCH queries (default: [2g, 10g, 50g])')
